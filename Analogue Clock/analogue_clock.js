...
let CIRCLE_TO_HOUR_RATIO = 360 / 12;
let  CIRCLE_TO_MINUTES_RATIO = 360 / 60;
let  CIRCLE_TO_MS_RATIO = 360 / 60000;

let DEGRESS_TO_RADIANS = Math.PI / 180;
...
function getRequiredSecondAngle(currentTime) {
	// Calculate the expected angle
	let secondsToMilliseconds = currentTime.getSeconds() * 1000;
	let totalMilliseconds = currentTime.getMilliseconds() + secondsToMilliseconds;
